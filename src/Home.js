...
class Home extends React.Component {
    ...
    render() {
        return <div className="welcome-container">
            ...
            <p>
                If you are perfectly well calibrated your score will exactly match the percentage you have chosen, if your score is lower then you are overconfident, if higher then you are underconfident.
            </p>
